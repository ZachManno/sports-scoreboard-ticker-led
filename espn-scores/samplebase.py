...
class SampleBase(object):
    def __init__(self, *args, **kwargs):
        ...
        self.parser.add_argument("--live-scores-only", dest="live_scores_only", help="To only display live scores, no preview or finals", action='store_false')
        self.parser.set_defaults(live_scores_only=False)
