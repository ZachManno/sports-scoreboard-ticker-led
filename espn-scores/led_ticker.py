    ...
    def write_scoreboard(self, offscreen_canvas, color, scoreboard):
        ...
        if scoreboard.gameclock.time_state:
            if scoreboard.gameclock.time_state == TimeState.FINAL:
                ...
                self.draw_team_image(offscreen_canvas, 'images/nfl/IND.png', 66)
                graphics.DrawText(offscreen_canvas, self.huge_font, 96, 16, self.yellow, '@')
                self.draw_team_image(offscreen_canvas, 'images/nfl/PHI.png', 104)
