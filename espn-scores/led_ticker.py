...
class GraphicsRunner(SampleBase):
    ...
    def write_scheduled_scoreboard(self, offscreen_canvas, color, scoreboard):
        ...
        scoreboard.gameclock.game_situation = GameSituation(down_and_distance="3rd and 7", home_team_has_ball=True,
                                                            away_team_has_ball=False, ball_on_yardline=5, ball_on_team='DET')
    ...
    def draw_possession(self, offscreen_canvas, scoreboard, pointing_direction='LEFT'):
        ...
        # Team Logos
        self.draw_team_image(offscreen_canvas, f'images/nfl/{scoreboard.home_team.city_abbr.upper()}.png', 64, 11, 10)
        self.draw_team_image(offscreen_canvas, f'images/nfl/{scoreboard.away_team.city_abbr.upper()}.png', 116, 11, 10)
